...
<html>
	...
	<body>
		...
		<article  class="collapsible">
			<header>
				<h3>Grammar, Emotions, and Philodophy in Thyagaraja's Compositions</h3>
		...
		<article  class="collapsible">
			...
			<img src="articles/img/vithala.jpg" class="img-left">
			<p>
			...
			<p>
				...
				chorus singing of the Dhruv Pad (normally the second line of the Abhang) and mostimportantly the Bhava aspect. The talam-beat is also specific with a Tod finale
				(Thirmanam).
			</p>
			<p>
			...
			<img src="articles/img/tukaram.jpg" class="img-right">
			<p>
			...
			<img src="articles/img/namdev.jpg" class="img-left">			
			<p>	
				“MAjhe manOratha pUrNa kari dEvA
				kEshavA mAdhavA nArAyaNA-
				nAhee nAhee maja ANika sOyarAna kari ou hErA pAMDuraMgA
			...
			<img src="articles/img/dhyaneshwar.jpg" class="img-right">
			<p>
			...
			<p>
				...
				wandering about nor in cupboards nor in deserts nor in forests. It is not obtainablefor a heap of riches. 
				It is neither in the heavens above nor in the entrails of the earth
		...
		<article  class="collapsible">
			<header>
				<h3>The Musical Plays or Operas</h3>
				<address class="author">Dr.R.Krishnaswami</address>
			</header>
		</article>
		<article  class="collapsible">
