   ...
   <body id="home">
      <div class="wrapper">
         <?php
            ...
            ?>
        <div id="content">
            <h2>Spring 2020 Concerts and Events</h2>
            CAMAGA have canceled all concerts and events scheduled for Spring 2020, due to concerns of Coronavirus.
            As announced earlier, we will soon arrange to return the cost of tickets/donations to those 
            who had purchased/donated for Trinity Drama. 
            We sincerely regret any inconvenience caused.
           
            <!-- Trinity drama START -->                   
            <h3>Trinity Drama - Event (scheduled for March 21, 2020) is Cancelled due to Coronavirus Concerns</h3>
            <p>
            The Trinity Drama scheduled to be held on March 21, 2020, Saturday has been canceled due to concerns of Coronavirus.
            We regret any inconvenience caused to you. On behalf of CAMAGA, we thank each of you for purchasing tickets and 
            supporting the event. We also sincerely thank our donors for their support for this event. We will soon arrange 
            to return the cost of tickets to those who had purchased tickets
            </p>
            <p><span style="color:#00868B;">CAMAGA committee</span></p>
            <!-- Trinity Drama End -->
